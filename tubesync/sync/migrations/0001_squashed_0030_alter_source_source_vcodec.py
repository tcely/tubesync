    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('write_json', models.BooleanField(default=False, help_text='Write a JSON file with the media info, these may be detected and used by some media servers', verbose_name='write json')),
            ],
            options={
                'verbose_name': 'Source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_file', models.FileField(blank=True, help_text='Media file', max_length=255, null=True, storage=django.core.files.storage.FileSystemStorage(location=str(settings.DOWNLOAD_ROOT)), upload_to=sync.models.get_media_file_path, verbose_name='media file')),
                ...
                ('downloaded_format', models.CharField(blank=True, help_text='Video format (resolution) of the downloaded media', max_length=30, null=True, verbose_name='downloaded format')),

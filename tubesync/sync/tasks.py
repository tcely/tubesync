...
from common.huey import dynamic_backoff
...
@dynamic_backoff(db_task, delay=10, priority=90, retries=15, queue=Val(TaskQueue.NET))
...
@dynamic_backoff(db_task, backoff_func=lambda n: (n*3600)+600, priority=50, retries=15, queue=Val(TaskQueue.LIMIT))
